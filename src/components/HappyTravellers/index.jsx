  ...
  return (
    <div className="container-fluid">
      <div className="container services-container d-flex justify-content-center flex-column py-5">
        ...
        <div className="mw-85 m-auto">
          <div className="row">
            <div className="col-md-4 col-lg-4 col-xs-12 col-sm-12 bg-image-happy-travellers">
            </div>
            <div className="col-md-7 col-lg-7 col-xs-12 col-sm-12">
              <div className="ms-3">
                ...
                <div className="mw-85">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</div>
